...
# Default-Stop:      0 1 6
# Short-Description: Read GPIO DS18B20 and post to redis + MQTT
# Description:       Read GPIO DS18B20 and post to redis + MQTT
### END INIT INFO
 
# Change the next 3 lines to suit where you install your script and what you want to call it
DIR=/usr/local/bin
DAEMON=${DIR}/pytemp.py
DAEMON_NAME=pytemp.py.py
